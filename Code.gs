...
function footerHtml_(text) {
  return '<div class="email-pad" style="padding:26px 30px 30px;background:' + BRAND.cream + ';border-top:1px solid ' + BRAND.line + ';text-align:center;">' +
    ...
    '<a class="social-link" href="' + SOCIAL_LINKS.facebook + '" target="_blank" rel="noopener" style="display:inline-block;vertical-align:middle;margin:4px;padding:9px 16px 9px 9px;border:1px solid ' + BRAND.deepGreen + ';border-radius:24px;background-color:' + BRAND.deepGreen + ';background-image:url(' + FACEBOOK_CTA_BACKGROUND_URL + ');background-size:cover;background-position:center;color:#ffffff;text-decoration:none;font-size:12px;font-weight:700;text-shadow:0 1px 3px rgba(0,0,0,.75);box-shadow:0 2px 5px rgba(18,55,42,.18);"><span style="display:inline-block;width:23px;height:23px;margin-right:6px;border-radius:50%;background:' + BRAND.gold + ';color:#ffffff;font-size:10px;line-height:23px;text-align:center;vertical-align:middle;">f</span>Join the Community on Facebook</a>' +
